...
class BrandDatum extends Common {
     ...
     * @return data:列表@
     * @data id:id bid:品牌id bname:品牌名 name:资料标题 datum:资料路由 size:大小 view:浏览量 download:下载量 createtime:创建时间
     * @author 开发者
     */
    public function index() {
        $m = new \app\admin\model\BrandDatum();
     ...
     * @param name:name type:int require:1 default:- other:- desc:资料标题
     ...
     * @param name:name type:int require:1 default:- other:- desc:资料标题
     * @param name:datum type:string require:1 default:- other:- desc:资料路由
     * @param name:view type:int require:0 default:- other:- desc:浏览量(修改时传)
     * @param name:download type:int require:0 default:- other:- desc:下载量(修改时传)
     * @author 开发者
     */
