...
class Maintenance extends Common {
     ...
     * @data id:id brand:电梯品牌 model:型号 floor_number:楼层数 type:维修类型 company:单位名称 province:省 city:市编号 area:区编号 location:电梯所在地 detail:详情地址(编辑) address:地址 status:-1取消0待审_1审核通过_2不通过_3已接单_4已完成_5投诉_6投诉已处理 receive_id:接单人id receive_time:接单时间 name:发布人姓名 avatar:发布人头像 company_name:发布人公司名称 receive_phone:接取人电话 receive_avatar:接取人头像 receive_name:接取人姓名 receive_company:接取人公司名称 image:图片
     ...
     * @return last_page:最后的页码
     * @return data:列表@
     * @data id:id brand:电梯品牌 model:型号 floor_number:楼层数 type:维修类型 company:单位名称 city:市编号 area:区编号 address:地址 createtime:创建时间 image:图片 is_draw:是否领取_1领取过_2未领取
     * @author 开发者
     */
     ...
     * @return last_page:最后的页码
     * @return data:列表@
     * @data id:id brand:电梯品牌 model:型号 floor_number:楼层数 status:-1取消0待审_1审核通过_2不通过_3已接单_4已完成_5投诉_6投诉已处理 type:维修类型 company:单位名称 city:市编号 area:区编号 address:地址 createtime:领取时间 name:发布人姓名 avatar:发布人头像 company_name:发布人认证公司 image:图片
     * @author 开发者
     */
     ...
     * @data id:id name:发单人姓名(投诉处理) avatar:发单人头像(投诉处理) company_name:发单人公司(投诉处理) brand:电梯品牌 model:型号 floor_number:楼层数 type:维修类型 company:单位名称 city:市编号 area:区编号 address:地址 status:-1取消0待审_1审核通过_2不通过_3已接单_4已完成_5投诉_6投诉已处理 createtime:创建时间 receive_time:接单时间(我的任务) complaint_time:投诉时间(投诉处理) evaluate:评价数据数组 image:图片
