...
CREATE TABLE `yunti_goods_order` (
  ...
  `status` int(2) DEFAULT NULL COMMENT '-1取消订单 0待支付 1支付 2已发货 3已收货 4退款',
  ...
  `expresscom` varchar(50) DEFAULT NULL COMMENT '快递公司',
  `expresssn` varchar(255) DEFAULT NULL COMMENT '快递单号',
