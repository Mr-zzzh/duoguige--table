...
if (!function_exists('login_comc')) {
    function login_comc() {
        $comc = array('admin/admin/login', 'admin/admin/register', 'mobile/index/login', 'mobile/index/city', 'mobile/user/code', 'mobile/user/register', 'mobile/goods/goodscate', 'mobile/goods/index');
        return $comc;
    }
}
//公共方法(无需权限限制)
