<template>
    <div class="sidebarleft">
        <el-menu  :collapse="collapse" :default-active="$route.path" :default-openeds="defaultitems"
        class="el-menu-vertical-demo sidebar-el-menu" 
        background-color="#1E222B" text-color="#ccc" @open="opensub" @close="closesub" active-text-color="#0177D5" unique-opened router>
        <!-- {{$route.path}} -->
        <!-- {{defaultitems}} -->
                ...
                <template v-if="item.subs">
                    <el-submenu :index="item.index" :key="item.index">
                        <template slot="title">
                            ...
                            <i class="Open" v-if="(item.index == openindex)&&(item.index!= closeindex)"><img src="../../../static/img/dfbrrbg35.png" alt=""></i>
