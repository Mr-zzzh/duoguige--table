<template>
    <div class="page">
        ...
        <!-- <el-button type="primary" style="margin-bottom: 20px;" @click="btn1">添加新分类</el-button> -->
<!--         
        ...
        <el-table
            ...
            <el-table-column
            prop="uname"
            label="购买人姓名" align="center"
            >
            </el-table-column>
            <el-table-column
            prop="uphone" align="center"
            label="购买人电话">
            </el-table-column>
            <el-table-column
        ...
        <span>
            <el-form ref="form" :model="form" label-width="100px">
                ...
                <el-form-item label="购买用户姓名">
                    <el-input v-model="form.uname" disabled></el-input>
                </el-form-item>
                <el-form-item label="购买人电话">
                    <el-input v-model="form.uphone" disabled></el-input>
                </el-form-item>
                <el-form-item label="订单号">
                    <el-input v-model="form.ordersn" disabled></el-input>
                </el-form-item>
        ...
        methods:{
            ...
            sc(e){
                this.$confirm('是否确定删除?', '提示', {
                    ...
                    this.$axios({
                        method:'delete',
                        url:`${this.api}admin/remind/${e.id}`,
                        data:{
                        }
                    }).then(res=>{
            ...
            bj(e){
                ...
                this.$axios({
                    method:'get',
                    url:`${this.api}admin/remind/${this.bjid}`,
                    params:{
